...
double test(double mousex, double mousey) {
...
int main(int argc, char* args[])
{
	...
	while (1) {
		...
		for (int i = 0; i < 10; i++) {
			for(int j=0;j < 10;j++)
				drawRectangle3D(basic, JUMA_MakeCollection(model, view, proj, "model", "view", "projection"), x*j, y*i, z, xr, yr, 0.0f, 0.5f, 0.5f, 0.5f);
		}
		drawTriangle3D(basic, JUMA_MakeCollection(model, view, proj, "model", "view", "projection"), x+0.9,y, z, xr, yr, 0.0f, 0.5f, 0.5f, 0.5f);
